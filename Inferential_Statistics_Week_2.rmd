...
-   **False 50% of houses in Ames are smaller than 1,499.69 square feet.**
...
-   **TRUE Each element represents a mean square footage from a simple random sample of 10 houses.**
...
-   **FALSE The variability of the sampling distribution with the smaller sample size (`sample_means50`) is smaller than the variability of the sampling distribution with the larger sample size (`sample_means150`).**
